...
INSURANCE_DATA = {
    ...
    "companies": {
        ...
        "Lotus Car Rental": {
            ...
            "notes": "Daily package prices are not published — must be obtained via booking quote. Platinum uniquely covers river crossings for 4x4 vehicles.",
            "included_base": [
                {"type": "tpl",  "deductible_isk": None,   "note": "Mandatory"},
            ...
            "packages": [
                ...
                },
                {
                    ...
                    "price_isk": None, "price_note": "~2,950–3,450 ISK/day (unconfirmed)",
                    "covers": ["tpl", "scdw", "tp", "gp", "saap", "tip", "froad", "river"],
                    "deductible_summary": "65k ISK",
                },
                {
                    "name": "Platinum Package", "tier": "zero",
                    "price_isk": None, "price_note": "~4,000–5,500 ISK/day (unconfirmed)",
        ...
        "Avis Iceland": {
            ...
            "highlight": "Add-on prices not published online",
            "notes": "Daily add-on prices are not published online. Deductibles split between passenger cars and all other groups (jeeps, minibuses, vans).",
            "included_base": [
                {"type": "tpl", "deductible_isk": None,   "note": "Mandatory"},
                {"type": "pai", "deductible_isk": None,   "note": "Mandatory by Icelandic law"},
                {"type": "cdw", "deductible_label": "195k–360k ISK", "deductible_isk": 195000, "note": "195k passenger cars / 360k jeeps, minibuses, vans"},
                {"type": "tp",  "deductible_isk": None,   "note": "Included with CDW at no extra fee"},
            ],
            "packages": [
                {
                    "name": "Base Rental", "tier": "base",
                    ...
                    "deductible_summary": "195k–360k ISK collision",
                },
                {
                    "name": "Super CDW", "tier": "addon",
                    "price_isk": None, "price_note": "~$23 USD/day (unpublished in ISK)",
                    "covers": ["scdw", "tp", "gp"],
                    "deductible_summary": "Reduced (amount unspecified)",
                },
                {
                    "name": "Wind & Gravel Protection", "tier": "addon",
                    "price_isk": None, "price_note": "Not published",
                    "covers": ["gp", "saap"],
                    "deductible_summary": "195k–360k ISK",
                },
                {
                    "name": "Complete Protection (CPP)", "tier": "zero",
                    "price_isk": None, "price_note": "~$29 USD/day est. (unpublished)",
                    "covers": ["tpl", "cdw", "scdw", "tp", "gp", "saap", "ra", "zero"],
                    "deductible_summary": "0 ISK all covered",
                },
            ],
        },
